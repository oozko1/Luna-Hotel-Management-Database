...
('Eylül', 'Yenihan', 'Front Office Supervisor', '05554445566', 1), 
('Aydýn', 'Özkol', 'Executive Chef', '05051112233', 1),      
('Emine', 'Özkol', 'Housekeeping Manager', '05054445566', 1), 
('Ahmet', 'Yýlmaz', 'Receptionist', '05051234567', 1);       

--Oda Tipleri Veri Giriþi 
...
--Oda bilgileri Giriþi 
-- Odalarý fiziksel olarak oluþturup tiplerine baðlýyoruz
INSERT INTO ROOMS (RoomNumber, RoomTypeID, Status)
VALUES 
--Oteliöizin 3 katlý olduðunu hayal edelim kat sayýsýna göre de room type id sini eþleþtiriyoruz
('101', 1, 'Available'), 
('102', 1, 'Dirty'),     
('103', 1, 'Available'), 
('104', 1, 'Available'), 
...
--Guests tablosu giriþi tek tek isim bulmam zor olacaðý için AI kullandým bu kýsýmda
...
('Oðuz', 'Korkmaz', '22334455667', 'TR', '05312223344', 'oguz.korkmaz@yahoo.com'),
('Buse', 'Aydýn', '33445566778', 'TR', '05323334455', 'buse.aydin@hotmail.com'),
...
('Zeynep', 'Yýldýz', '66778899001', 'TR', '05356667788', 'zeynep.yildiz@gmail.com'),
('Emre', 'Güneþ', '77889900112', 'TR', '05367778899', 'emre.gunes@yandex.com'),
('Burak', 'Þahin', '88990011223', 'TR', '05378889900', 'burak.sahin@gmail.com'),
...
-- Diðer Ülkeler ve Ekstra Karakterler
...
-- Ekstra Karakterler (Sistemi Zorlamak Ýçin)
('Ali', 'Kuþçu', '12121212121', 'TR', '05411212121', 'ali.kuscu@edu.tr'),
...
--sayýyý kontrol ediyorum 
SELECT COUNT(*) AS Sayý FROM GUESTS;

--ayný þekilde AI yardýmý ile reservations tablosunu dolduruyorum 
...
--artýk sorgu yapabilecek kadar belirli bi veri var elimizde çoðunluðun manuel giriþ olmasýný istediðim için
--bir yerden sonra fazla veri giriþi yapamadým çünkü genel olarak insert into mantýðý ayný 
